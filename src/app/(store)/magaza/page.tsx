  ...
  return (
    <main id="ana-icerik" className="store-page">
      <header className="store-masthead">
        <div className="shell">
          <p className="pt-4 text-sm text-[color:var(--store-muted-dark)]">
          ...
          <div className="store-intro">
            <div>
              ...
              <h1 className="store-intro-title mt-2">{title}</h1>
            </div>
            <div className="store-intro-aside">
      ...
      {isGenuinelyEmpty ? (
        ...
        <div className="shell pt-2" data-visual-landmark>
          <Suspense fallback={null}>
              ...
              <section className="min-w-0 pt-5" data-visual-landmark data-catalog-results>
                ...
                {page.items.length > 0 ? (
                  ...
                  <div className="flex min-h-72 flex-col items-center justify-center text-center">
                    <SearchX aria-hidden="true" className="size-8 text-[color:var(--store-muted-dark)]" />
