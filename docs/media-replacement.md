...
| Category hero | `categories.image_url` | PNG at `public/demo/categories/{slug}.png` or Admin → Kategoriler upload |
...
| `/` | Category worlds | `/demo/categories/{slug}.png` | 2:1 or 4:5 | Optional | Category photograph | Right-safe overlay |
...
| `/magaza/[category]` | Masthead | category PNG | ~16:9 | No if scene | Category lifestyle or first product | Title left, art right |
